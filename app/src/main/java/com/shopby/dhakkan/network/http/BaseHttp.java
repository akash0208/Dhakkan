package com.shopby.dhakkan.network.http;
...
public abstract class BaseHttp extends AsyncTask<Void, Void, String> {
    ...
    public BaseHttp(Context context, String requestUrl) {
        if(requestUrl.contains("?")) {
            requestUrl = requestUrl + "&consumer_key=ck_1a5468c652adbff3f2e130fd391895cc34c065f6&consumer_secret=cs_67c9979382186c4717fca725dda68110470c7bc6";
        }
        else {
            requestUrl = requestUrl + "/?consumer_key=ck_1a5468c652adbff3f2e130fd391895cc34c065f6&consumer_secret=cs_67c9979382186c4717fca725dda68110470c7bc6";
        }
        ...
        Log.e("API CHECK", "doInBackground: " + requestUrl);
    }
    ...
    protected String doInBackground(Void... max) {
        ...
        if (isNetworkAvailable(mContext)) {
            ...
            Log.d("API CHECK", "doInBackground: yyyy " + requestUrl);
