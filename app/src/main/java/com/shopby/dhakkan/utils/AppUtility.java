...
public class AppUtility {
    ...
    public static void showCustomToast(Activity activity, String message) {
        ...
        TextView tvToastMsg = toastRoot.findViewById(R.id.tvToastMsg);
    ...
    public static void invokeWhatsappBot(Activity activity) {
        PackageManager packageManager = activity.getPackageManager();
        Intent i = new Intent(Intent.ACTION_VIEW);

        try {
            String url = "https://api.whatsapp.com/send?phone=+917303737950&text=" + URLEncoder.encode("", "UTF-8");
    ...
    public static void invokeMessengerBot(Activity activity) {
        try {
            if (isPackageInstalled(activity.getApplicationContext(), "com.facebook.orca")) {
                ...
                activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("fb://messaging/" + 857536967916323l))); // replace id
            } else {
